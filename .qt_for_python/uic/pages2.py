...
class Ui_StackedWidget(object):
    def setupUi(self, StackedWidget):
        ...
        StackedWidget.resize(841, 558)
        StackedWidget.setMinimumSize(QSize(841, 0))
        self.page_1 = QWidget()
        ...
        self.tabWidget.setGeometry(QRect(-10, 60, 851, 501))
...
"color: rgb(0, 0, 0);")
        ...
        self.label_3.setGeometry(QRect(210, 125, 91, 21))
        self.label_3.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.label_4 = QLabel(self.tab)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(210, 175, 91, 21))
        self.label_4.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.label_5 = QLabel(self.tab)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(210, 225, 91, 21))
        self.label_5.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.label_6 = QLabel(self.tab)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(210, 75, 91, 21))
        self.label_6.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.le_nome = QLineEdit(self.tab)
        self.le_nome.setObjectName(u"le_nome")
        self.le_nome.setGeometry(QRect(330, 120, 231, 31))
...
"")
        ...
        self.le_cpf.setGeometry(QRect(330, 220, 231, 31))
...
"")
        ...
        self.le_email.setGeometry(QRect(330, 170, 231, 31))
...
"")
        ...
        self.le_celular.setGeometry(QRect(330, 70, 231, 31))
...
"")
        ...
        self.add_btn.setGeometry(QRect(250, 330, 101, 41))
        self.add_btn.setStyleSheet(u"font: 11pt \"Century Gothic\";\n"
"background-color: rgb(98, 114, 164);\n"
"color: rgb(255, 255, 255);")
        self.update_btn = QPushButton(self.tab)
        self.update_btn.setObjectName(u"update_btn")
        self.update_btn.setGeometry(QRect(360, 330, 101, 41))
        self.update_btn.setStyleSheet(u"font: 11pt \"Century Gothic\";\n"
"background-color: rgb(98, 114, 164);\n"
"color: rgb(255, 255, 255);")
        self.delete_btn = QPushButton(self.tab)
        self.delete_btn.setObjectName(u"delete_btn")
        self.delete_btn.setGeometry(QRect(470, 330, 101, 41))
        self.delete_btn.setStyleSheet(u"font: 11pt \"Century Gothic\";\n"
"background-color: rgb(98, 114, 164);\n"
"color: rgb(255, 255, 255);")
        self.le_id = QSpinBox(self.tab)
        self.le_id.setObjectName(u"le_id")
        self.le_id.setGeometry(QRect(330, 270, 231, 31))
        self.le_id.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.label_7 = QLabel(self.tab)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(210, 270, 91, 31))
...
"color: rgb(255, 255, 255);")
        self.refresh_btn = QPushButton(self.tab_3)
        self.refresh_btn.setObjectName(u"refresh_btn")
        self.refresh_btn.setGeometry(QRect(660, 370, 151, 51))
...
"color: rgb(255, 255, 255);")
        ...
        self.label.setGeometry(QRect(0, 0, 841, 61))
...
"")
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.label_7.setText(QCoreApplication.translate("StackedWidget", u"ID", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("StackedWidget", u"Cadastro", None))
