...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(400, 300)
        self.page_1 = QWidget()
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label_1.setText(QCoreApplication.translate("application_pages", u"Page_1", None))
        self.label_2.setText(QCoreApplication.translate("application_pages", u"Page_2", None))
        self.label_3.setText(QCoreApplication.translate("application_pages", u"Page_3", None))
    # retranslateUi
